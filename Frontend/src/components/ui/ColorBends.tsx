...
/**
 * Tuned defaults: a slow, subdued "molten gold" wash (brass tones fading to
 * near-black) instead of the original loud multi-color rainbow preset —
...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    const loop = () => {
      ...
      // Respect prefers-reduced-motion: render exactly one frame, then stop.
    ...
    return () => {
      ...
      else if (resizeListenerAttached) window.removeEventListener('resize', handleResize);
      geometry.dispose();
      material.dispose();
      renderer.dispose();
